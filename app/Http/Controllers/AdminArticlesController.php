<?php namespace App\Http\Controllers;
	...
	class AdminArticlesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Published By","name"=>"published_by"];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Article Datetime","name"=>"article_datetime","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
			...
			//$this->form[] = ["label"=>"Published By","name"=>"published_by","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			# OLD END FORM
